...
def sum_rows():
    ...
    def processar_csv(file_path):
        ...
        df_agrupado = df.groupby('Cód.').agg({
    ...
    # Exemplo de uso
    file_path = 'csv/pop-residente-2022.csv'  # Substitua pelo caminho do seu arquivo CSV
...
input_csv = 'csv/ok/data.csv'
output_csv = 'output_arquivo.csv'
columns_to_remove = ['Nome do Município', 'Ano', 'Ano_x', 'UF', 'Nome UF', 'Município', 'Ano_y']
